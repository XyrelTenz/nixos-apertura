...
hl.animation({ leaf = "windowsIn",  enabled = true, speed = 1,   bezier = "easeOutQuint", style = "popin 92%" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 1, bezier = "easeOutQuint", style = "popin 92%" })
...
hl.animation({ leaf = "layers",        enabled = true, speed = 1, bezier = "easeOutQuint", style = "popin 90%" })
hl.animation({ leaf = "fadeLayersIn",  enabled = true, speed = 1, bezier = "easeOutQuint" })
hl.animation({ leaf = "fadeLayersOut", enabled = true, speed = 1, bezier = "easeOutQuint" })
