...
Item {
    ...
    Timer {
        interval: 20000
        running: wifiRoot.hasWifiCard && wifiRoot.wifiEnabled
        repeat: true
        ...
        ColumnLayout {
            ...
            Item {
                ...
                Text {
                    ...
                    text: !wifiRoot.wifiEnabled ? "signal_wifi_off" : (wifiRoot.ssid === "Disconnected" || wifiRoot.ssid === "" ? "perm_scan_wifi" : wifiRoot.signalStrength < 25 ? "network_wifi_1_bar" : wifiRoot.signalStrength < 50 ? "network_wifi_2_bar" : wifiRoot.signalStrength < 75 ? "network_wifi_3_bar" : "network_wifi")
        ...
        ColumnLayout {
            ...
            StackLayout {
                ...
                ColumnLayout {
                    ...
                    TextField {
                        ...
                        background: Rectangle {
                            color: rootScope.theme ? rootScope.theme.theme_onPrimary : "#11111b"
                            border.color: parent.activeFocus ? (rootScope.theme ? rootScope.theme.theme_primary : "#ffffff") : (rootScope.theme ? rootScope.theme.theme_outline : "#26ffffff")
                            border.width: 1
                            radius: 4
                        }
                        Keys.onPressed: event => {
                    ...
                    RowLayout {
                        ...
                        Button {
                            ...
                            background: Rectangle {
                                color: parent.hovered ? (rootScope.theme ? rootScope.theme.theme_outline : "#26ffffff") : (rootScope.theme ? rootScope.theme.theme_onPrimary : "#11111b")
                                radius: 4
                            }
                        ...
                        Button {
                            ...
                            background: Rectangle {
                                color: parent.hovered ? (rootScope.theme ? rootScope.theme.theme_outline : "#40ffffff") : (rootScope.theme ? rootScope.theme.theme_onPrimary : "#11111b")
                                radius: 4
                            }
                ...
                ColumnLayout {
                    ...
                    Layout.fillWidth: true
                    Text {
                        text: "Connected to: " + wifiRoot.selectedSsid
                        font.family: "Rubik"
                        font.pixelSize: 12
                        color: rootScope.theme ? rootScope.theme.theme_fg : "#ffffff"
                    }
